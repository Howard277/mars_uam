...
(function (za, N, l) {
    var M = function (g) {
        ...
        function V(a) {
            ...
            e && b.bCollapse && (k.maxHeight = s(e), k.height = "auto", b = c && ba.offsetWidth > j.offsetWidth ? f : 0, ba.offsetHeight < j.offsetHeight );
            b = q.outerWidth();
            m[0].style.width = s(b);
            n.width = s(b);
